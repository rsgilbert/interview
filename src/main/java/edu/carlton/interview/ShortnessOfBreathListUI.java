 ...
 * @author SSG
 */
public class ShortnessOfBreathListUI extends javax.swing.JFrame {

    /**
     * Creates new form PatientListUI
     */
    public ShortnessOfBreathListUI() {
        initComponents();
        loadInformation();
      }
    ...
    private void initComponents() {
        ...
        jMenu5.setText("Activity Tolerance");
...
// CardLayout card = (CardLayout)  mainPanel.getLayout();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShortnessOfBreathListUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShortnessOfBreathListUI().setVisible(true);
            }
        });
    }
